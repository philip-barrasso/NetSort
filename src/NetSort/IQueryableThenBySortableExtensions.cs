...
namespace NetSort
{
    public static partial class SortableExtensions
    {
        ...
        /// <param name="delimiter">The char used to separate nested properties</param>
        public static IOrderedQueryable<T> ThenSortByKey<T>(this IOrderedQueryable<T> items, string key, char delimiter, SortDirection direction) where T : class
        {
        ...
        /// <param name="items">The data to sort</param>
        /// <param name="key">The 'key' to sort by. This key must be present as the 'SortKey' of exactly one 'SortableAttribute' on a property of type T</param>
        public static IOrderedQueryable<T> ThenSortByKey<T>(this IOrderedQueryable<T> items, string key) where T : class
        {
        ...
        /// <param name="key">The 'key' to sort by. This key must be present as the 'SortKey' of exactly one 'SortableAttribute' on a property of type T</param>
        /// <param name="direction">The direction to sort (Asc | Desc)</param>
        public static IOrderedQueryable<T> ThenSortByKey<T>(this IOrderedQueryable<T> items, string key, SortDirection direction) where T : class
        {
        ...
        /// <param name="direction">The direction to sort (Asc | Desc)</param>
        /// <param name="delimiter">The char used to separate nested properties</param>
        public static IOrderedQueryable<T> ThenSortByKey<T>(this IOrderedQueryable<T> items, string key, char delimiter, string direction) where T : class
        {
        ...
        /// <param name="key">The 'key' to sort by. This key must be present as the 'SortKey' of exactly one 'SortableAttribute' on a property of type T</param>
        /// <param name="direction">The direction to sort (Asc | Desc)</param>
        public static IOrderedQueryable<T> ThenSortByKey<T>(this IOrderedQueryable<T> items, string key, string direction) where T : class
        {
            return ThenSortByKey(items, key, Constants.DEFAULT_NESTED_PROP_DELIMITER, direction);
        }

        private static IOrderedQueryable<T> DoThenSort<T>(IOrderedQueryable<T> items, string key, char delimiter, SortDirection? direction) where T : class
        {
        ...
        private static IOrderedQueryable<T> ThenSort<T>(IOrderedQueryable<T> items, IEnumerable<SortOperationMetadata> metadata)
        {
